...
assert.match(popup, /RETRY_ML_BATCH/);
assert.match(background, /UPLOAD_CHUNK_SIZE/);
assert.match(background, /retryableCandidates/);
assert.match(background, /retryFailedBatch/);
...
assert.match(background, /PAGE_READY_DELAY_MS = 5000/);
assert.match(content, /AFFILIATE_UI_TIMEOUT_MS = 8000/);
assert.match(content, /waitForAffiliateUi/);
