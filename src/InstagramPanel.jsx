  ...
  return <div className="instagram-admin-layout">
    ...
    <section className="panel instagram-settings">
      ...
      <div className="settings-grid three-columns">
        ...
        <label>Máximo por dia<input type="number" min="1" max="100" value={config.instagramMaxPerDay ?? 15} onChange={(event) => setConfig({ instagramMaxPerDay: event.target.value })} /></label>
